<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $email = $_POST['email'];
        $amount = $_POST['amount'];
        $sql = "INSERT INTO `users` (`sno`, `name`, `email`, `amount`) VALUES('{$sno}''{$name}','{$email}','{$amount}')";
    ...
    <div class="screen">
      ...
      <div class="screen-body">
        <div class="screen-body-item left">
          <img class="img-fluid" src="images/customer.png" style="border: none; border-radius: 30%;">
        </div>
